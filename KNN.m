...
currentDist(labelledCaseIdx,:) = [euc(unlabelledCase, labelledCase) trainingTarget(labelledCaseIdx)];
% Check the distance
end % inner loop
sorted_matrix=sortrows(currentDist);
shortestDistanceLabel=mode(sorted_matrix(1:k,2));
